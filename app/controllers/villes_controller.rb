class VillesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ville.save
        format.html { redirect_to ville_url(@ville), notice: "Ville was successfully created." }
  ...
  def update
    respond_to do |format|
      if @ville.update(ville_params)
        format.html { redirect_to ville_url(@ville), notice: "Ville was successfully updated." }
